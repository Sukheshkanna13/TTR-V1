...
const BookingWizard = ({ go, ctx, onSubmit }) => {
  ...
  return (
    <div className="tt-page" style={{ paddingTop: 56, paddingBottom: 96, maxWidth: 1100 }}>
      ...
      {/* Stepper */}
      <div style={{ display: 'flex', gap: 0, marginTop: 40, marginBottom: 40, borderBottom: '1px solid var(--line)', overflowX: 'auto' }}>
        {labels.map((l, i) => (
      ...
      <div className="tt-booking-layout" style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: 56 }}>
        <div>
              ...
              <div style={{ marginTop: 20, padding: 24, border: '1px solid var(--line)', borderRadius: 6 }}>
                <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                  <div style={{ width: 80, height: 80, borderRadius: 4, overflow: 'hidden', flexShrink: 0 }}>
                    <StripeImg label={ctx.property.placeholder} tone={ctx.property.tone} ratio="auto"/>
                  </div>
                  <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 40, paddingTop: 24, borderTop: '1px solid var(--line)', gap: 12, flexWrap: 'wrap' }}>
